...
export default function PrivacyPage() {
  ...
  useEffect(() => {
    ...
    const register = async () => {
      ...
      await context.registerTool({ name: "open_privacy_playground", title: "Open privacy playground", description: "Navigate to the privacy demonstration page. Discover this page's tools after navigation.", inputSchema: { type: "object", properties: {}, additionalProperties: false }, annotations: { readOnlyHint: true, consequentialHint: false }, execute: () => { window.location.assign("/privacy"); return { ok: true, navigatingTo: "/privacy" }; } }, { signal: controller.signal });
      setNative(true);
    };
